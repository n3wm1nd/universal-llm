...
buildStreamingRequest :: [ModelConfig (Model TestModels.ClaudeSonnet45NoReason Provider.AnthropicOAuth)]
                     ...
                     -> AnthropicRequest
buildStreamingRequest configs msgs = buildStreamingRequestGeneric TestModels.anthropicSonnet45NoReasonOAuth (Model TestModels.ClaudeSonnet45NoReason Provider.AnthropicOAuth) def configs msgs
